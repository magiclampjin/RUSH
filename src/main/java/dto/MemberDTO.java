...
public class MemberDTO {
	...
	public String getFormedBirth() {
		...
		if (Integer.parseInt(century) < 3) {
			result = "19" + Birth.substring(0, 2) + "년 " + Birth.substring(2, 4) + "월 " + Birth.substring(4, 6) + "일생";
		} else {
			result = "20" + Birth.substring(0, 2) + "년 " + Birth.substring(2, 4) + "월 " + Birth.substring(4, 6) + "일생";
		}
