			...
			<div class="gameContainer">
				<div class="row g-0">
						...
						<div class="row g-0">
							<div class="col-12 mt-5">
								<div class="btn-group-vertical" role="group"
									...
									<button type="button" class="btn btn-dark bColorBlack active"><span class="fontKorean text-white">퍼즐게임</span></button>
									<!-- js로 넘어가기 -->
								</div>
							</div>
						</div>
					...
					<div class="col-10 pr45">
						<div class="row g-0">
							<div class="col-12">
								<p class="gameCategory fs-5 mb-0 text-white fontKorean">퍼즐 게임</p>
							</div>
						</div>
						<div class="row g-0">
							<div class="col-10">
